...
import remoteImg from "../../../../assets/9ac5963fc0e77b27818e101e597556691793370f.webp";

const newportImg = "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&q=80&w=800";
const californiaImg = "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&q=80&w=800";
        ...
        <div className="grid grid-cols-12 gap-8 md:gap-16 items-stretch">
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col">
            ...
            >
              ...
              <h2 className="text-[32px] md:text-[52px] lg:text-[72px] leading-[1.1] text-[#03030f] mb-6 md:mb-8 font-semibold" style={{ fontFamily: "'Inter Tight', sans-serif" }}>
          ...
          {/* Right Side: Image Grid — stretches to match left column */}
          <div className="col-span-12 lg:col-span-6 grid grid-cols-2 gap-3 md:gap-4 h-full">
            <div className="col-span-1 flex flex-col gap-3 md:gap-4 h-full">
              ...
              >
                <ImageWithFallback src={newportImg} alt="Newport Beach, CA" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
              ...
              <motion.div
                ...
                className="relative rounded-[16px] md:rounded-[20px] overflow-hidden group flex-1 min-h-[160px]"
              >
                <ImageWithFallback src={californiaImg} alt="California" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
            ...
            <div className="col-span-1 h-full">
              ...
              >
                <ImageWithFallback src={remoteImg} alt="Remote Support" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
