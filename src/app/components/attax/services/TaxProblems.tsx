...
export function TaxProblems() {
  return (
    <section id="tax-problems" className="py-[120px] bg-[#0a1628] text-white scroll-mt-[120px] relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center text-center mb-20 max-w-[900px] mx-auto">
          ...
          <h2 
            className="text-[42px] lg:text-[52px] leading-[1.1] text-white font-medium mb-8"
            style={{ fontFamily: "'Inter Tight', sans-serif" }}
          >
            Facing One of These? <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {problems.map((problem, idx) => (
            <motion.div 
              ...
              className={`bg-white/5 border border-white/10 rounded-[32px] p-10 hover:bg-white/10 transition-all duration-500 group
                ${idx === 3 ? "lg:col-span-1" : ""}
                ${idx === 4 ? "lg:col-span-2" : ""}
              `}
            >
              <div className="flex items-start justify-between mb-8">
                <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center text-[#a5b4fc] group-hover:bg-[#1d1ee3] group-hover:text-white transition-all duration-300">
              ...
              <div className="pt-8 border-t border-white/10">
                <p className="text-[15px] italic text-[#f59e0b] font-medium leading-relaxed" style={{ fontFamily: "'Playfair Display', serif" }}>
                  "{problem.impact}"
                </p>
              </div>
            </motion.div>
