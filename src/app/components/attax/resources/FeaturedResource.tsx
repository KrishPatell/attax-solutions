      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="w-full md:w-[55%] p-10 lg:p-14 flex flex-col justify-center">
            <blockquote 
              className="text-[#0a1628] text-[24px] lg:text-[28px] leading-[1.4] mb-10 font-normal"
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 border-t border-[rgba(0,0,0,0.05)] pt-10">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                className="group flex items-center gap-2 bg-[#1d1ee3] text-white rounded-full pl-6 pr-1 py-1.5 transition-all"
              >
                <span className="text-[14px] font-medium px-2">Read Case Study</span>
                <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#1d1ee3] group-hover:rotate-45 transition-transform duration-300">
