    ...
    <section className="pb-[120px] bg-white">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        ...
        >
          ...
          {/* Left: Content */}
          <div className="w-full md:w-[55%] p-10 lg:p-16 flex flex-col justify-center relative z-10">
            <span 
            ...
            <h2 
              className="text-[40px] lg:text-[56px] leading-[1.1] text-white font-medium mb-10"
              style={{ fontFamily: "'Inter Tight', sans-serif" }}
            >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 mb-12">
              <motion.button 
                ...
                className="w-full sm:w-auto flex items-center justify-between gap-4 bg-white text-[#1d1ee3] rounded-full px-8 py-4 font-bold text-[16px] group transition-all"
              >
