        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-6">
              <h2 className="text-[56px] leading-[1.1] text-[#0a1628] font-medium font-['Inter_Tight']">
                Friendly Asked <br />
                <span className="italic font-['Playfair_Display']">Questions.</span>
              </h2>
            </div>

            <div className="bg-[#f7f9ff] p-10 rounded-[24px] border border-[#eaeeff] flex flex-col gap-6 max-w-[400px]">
              <h3 className="text-[24px] font-semibold text-[#0a1628] font-['Inter_Tight']">
                Still have a question?
              </h3>
              <p className="text-[#0a1628]/60 text-[16px] font-['Inter_Tight']">
                Our team is ready to assist you with any questions you may have.
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-[#1d1ee3] text-white rounded-full px-8 py-4 flex items-center justify-between group"
              >
                <span className="font-medium font-['Inter_Tight']">Make a Call</span>
                <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center rotate-45 group-hover:rotate-90 transition-transform">
          ...
          <div className="flex flex-col border-t border-[#eaeeff]">
            {faqs.map((faq, i) => (
              <div key={i} className="border-b border-[#eaeeff]">
                ...
                >
                  <span className={`text-[18px] font-medium font-['Inter_Tight'] transition-colors ${openIndex === i ? 'text-[#1d1ee3]' : 'text-[#0a1628] group-hover:text-[#1d1ee3]'}`}>
                    {faq.question}
                  </span>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${openIndex === i ? 'bg-[#1d1ee3] text-white rotate-180' : 'bg-[#f0f4ff] text-[#1d1ee3]'}`}>
                ...
                >
                  <p className="pb-8 text-[#0a1628]/60 text-[16px] leading-relaxed font-['Inter_Tight']">
                    {faq.answer}
                  </p>
                </motion.div>
              </div>
