import svgPaths from "./svg-2lgb454t5i";
...
function SectionContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center justify-center max-w-[1200px] min-w-[1200px] px-[30px] py-[120px] relative shrink-0 w-[1200px]" data-name="Section - Container">
      <HeaderButton />
      <DesktopMonthly />
    </div>
  );
